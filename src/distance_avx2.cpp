...
float l2_simd(const float* a, const float* b, int dim) noexcept {
    ...
    float sum = result[0] + result[1] + result[2] + result[3] + result[4] + result[5] + result[6] +
                result[7];
...
float cosine_simd(const float* a, const float* b, int dim) noexcept {
    ...
    float dot = dot_arr[0] + dot_arr[1] + dot_arr[2] + dot_arr[3] + dot_arr[4] + dot_arr[5] +
                dot_arr[6] + dot_arr[7];
    float norm_a = norm_a_arr[0] + norm_a_arr[1] + norm_a_arr[2] + norm_a_arr[3] + norm_a_arr[4] +
                   norm_a_arr[5] + norm_a_arr[6] + norm_a_arr[7];
    float norm_b = norm_b_arr[0] + norm_b_arr[1] + norm_b_arr[2] + norm_b_arr[3] + norm_b_arr[4] +
                   norm_b_arr[5] + norm_b_arr[6] + norm_b_arr[7];
